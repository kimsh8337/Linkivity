    ...
    <div>
        ...
        <div style="height:15rem">
            <div class="d-flex justify-content-between" style="width:100%">
                <!-- 프로필 보여주기 -->
                <img class="profile-image d-flex my-2" :src="slide.proimg">
                <div class="mt-2 mr-4 ml-0">
                    <div class="d-flex">
                        <small class="d-flex align-items-center mb-2" style="font-weight:bold">{{slide.nickname}}</small><br>
                    </div>
                    <div class="d-flex">
                        <i class="fas fa-star d-flex" style="color:Salmon;" v-for="i in slide.star" :key="i.id"></i>
                    </div>
                </div>
                <!-- 날짜 및 수정 삭제 -->
