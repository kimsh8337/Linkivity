          ...
          <th class="admin-black-out">취소/경고/탈퇴</th>
            ...
            <tbody>
              <tr v-for="(blacklist, index) in blacklists" :key="index">
                ...
                <td>
                  <button class="admin-black-warn" @click="warnblack(blacklist.rpid)">경고</button
                  ><button class="admin-black-drop" @click="dropblack(blacklist.rpid)">탈퇴</button
                  ><button class="admin-black-cancel" @click="cancelblack(blacklist.rpid)">취소</button>
                </td>
              </tr>
            </tbody>
          </table>
